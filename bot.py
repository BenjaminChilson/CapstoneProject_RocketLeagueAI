...
env = rlgym.make(game_speed=100, tick_skip=30, obs_builder=OurObsBuilder(), terminal_conditions=[GoalScoredCondition(), NoTouchTimeoutCondition(max_steps=225)], reward_fn=GroupRewardFunction())
